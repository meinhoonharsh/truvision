...
@section('content')
    ...
    <div class="accordion-container">
        <div class="accordion">
            {{-- {% set faqs = [
            ["Where is The TVF based? Do you travel worldwide?","We cover PAN India, Destination coverages - Rajasthan, Udaipur, Goa, Jaipur. We have a team to cater to international wedding coverages like Thailand, Bangkok, Switzerland, Turkey, Dubai."],
            ["Is TVF into wedding planning or just coverage?","Currently, we are only into coverage (photos and videos) but having worked with some of the top wedding management teams, we are happy to suggest some names at no extra cost. We are into wedding photography & video coverages."],
